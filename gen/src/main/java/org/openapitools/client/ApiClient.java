...
public class ApiClient {
    ...
    private String basePath = "https://us-ev-api.experian.com/consumerservices/verification/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("OauthSecurity", new OAuth());
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "https://us-api.experian.com/oauth2/v1/token";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://us-ev-api.experian.com/consumerservices/verification/v1
